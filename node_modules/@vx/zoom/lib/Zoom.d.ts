...
declare class Zoom extends React.Component<ZoomProps, ZoomState> {
    ...
    translate: ({ translateX, translateY }: Pick<TransformMatrix, "translateX" | "translateY">) => void;
    translateTo: ({ x, y }: Point) => void;
    setTranslate: ({ translateX, translateY }: Pick<TransformMatrix, "translateX" | "translateY">) => void;
    ...
    constrain: (transform: TransformMatrix, prevTransform: TransformMatrix) => TransformMatrix;
    dragStart: (event: React.MouseEvent<Element, MouseEvent>) => void;
    dragMove: (event: React.MouseEvent<Element, MouseEvent>) => void;
    dragEnd: () => void;
    handleWheel: (event: WheelEvent | React.WheelEvent<Element>) => void;
    toString: () => string;
    center: () => void;
    clear: () => void;
